...
<section class="wrapper section-padding ourAdvices">
  ...
  <div class="swapItem">
    ...
    <div class="wrapper--medium-up">
        <iframe width="100%" height="500px" src="" data-src="<?php print $iframe_url; ?>" frameborder="0" allowfullscreen="allowfullscreen" allowtransparency="true" scrolling="yes"></iframe>
    </div>
    </div>
  </div>
  <?php endif; ?>
