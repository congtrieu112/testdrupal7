...
<script language="JavaScript">
  ...
  <script language="JavaScript">
    ...
    fn_BodyOnLoad(1); // recalcul immÃ©diat
    }
    ...
    { ers="PrÃ©cisez le type d'acquisition !";
    }
    else
    ...
    if(t_PretPth <0) { ers="Montant du prÃªt : saisie invalide" ; }
    else
    if(TypeAchat==1 && (terrain==0 && logement==0))
    { ers="PrÃ©cisez le prix du terrain et/ou du logement !";
    }
    else
    if((TypeAchat==2 || TypeAchat==3) && logement<=0)
    { ers="PrÃ©cisez le prix du logement !";
    }
    else
    if(TypeAchat==4 && (logement==0 && travaux==0))
    { ers="PrÃ©cisez le prix du logement et/ou des travaux !";
    }
    else
    if(!g_IsChange1)
    { ///ers="RÃ©sultats dÃ©jÃ  calculÃ©s !";
    }
    if(ers!="" && IsAlert)
    { self.alert(ers);
    }
    ...
    ? brm.EmolFixeNeufT
    : brm.EmolFixeAncien;
    // en DOM (Guadeloupe, Guyane, Martinique) : emolument majorâ€šs +25%, mayotte= +40%
  ...
  <body bgcolor="#FFFFFF" onload="fn_BodyOnLoad(0)">
    <form name="ffff" onsubmit="return BeforeSubmit(ffff,1)" method="POST">
      <table align="center" border="0" cellspacing="8" cellpadding="0">
        <tr>
          <td align="center" colspan="2"><font class="titre1">
              Calculez vos frais
              de notaire et dhypothèque</font></td>
        </tr>
        <tr>
          <td valign="top" class="tdg">
            <table border="0" cellspacing="1" cellpadding="4" width="100%" class="tab1">
              <tr>
                <td align="center" class="td0">Votre projet immobilier</td>
              </tr>
              <tr>
                <td valign="top">
                  <table border="0" cellspacing="0" cellpadding="2" width="100%">
                    <tr>
                      <td nowrap="" colspan="2" class="td1">
                    ...
                    <tr>
                      <td nowrap="" colspan="2" class="td1">
                        ...
                        <select name="NumDept" size="1" onchange="ffff_OC('NumDept')" style="float:right;">
                          ...
                          <option value="13">13-Bouches-du-Rh&Atilde;&acute;ne</option>
                          ...
                          <option value="21">21-C&Atilde;&acute;te-d&apos;Or</option>
                          <option value="22">22-C&Atilde;&acute;tes-d&apos;Armor</option>
                          <option value="23">23-Creuse</option>
                          <option value="24">24-Dordogne</option>
                          <option value="25">25-Doubs</option>
                          <option value="26">26-Dr&Atilde;&acute;me</option>
                          ...
                          <option value="63">63-Puy-de-D&Atilde;&acute;me</option>
                          <option value="64">64-Pyrénées-Atlantiques</option>
                          <option value="65">65-Hautes-Pyrénées</option>
                          <option value="66">66-Pyrénées-Orientales</option>
                          <option value="67">67-Bas-Rhin</option>
                          <option value="68">68-Haut-Rhin</option>
                          <option value="69">69-Rh&Atilde;&acute;ne</option>
                          <option value="70">70-Haute-Sa&Atilde;&acute;ne</option>
                          <option value="71">71-Sa&Atilde;&acute;ne-et-Loire</option>
                    ...
                    <tr>
                      <td nowrap="" class="td1">Prix du terrain :</td>
                      <td nowrap="" class="td1">
                        <input name="terrain" size="7" maxlength="8" onchange="ffff_OC('terrain')" class="put1">&nbsp;&euro;
                      </td>
                    </tr>
                    <tr>
                      <td nowrap="" class="td1">Prix du logement ou construction :</td>
                      <td nowrap="" class="td1">
                        <input name="logement" size="7" maxlength="8" onchange="ffff_OC('logement')" class="put1">&nbsp;&euro;
                      </td>
                    </tr>
                    <tr>
                      <td nowrap="" class="td1">Coût des travaux additionnels :</td>
                      <td nowrap="" class="td1">
                        <input name="travaux" size="7" maxlength="8" onchange="ffff_OC('travaux')" class="put1">&nbsp;&euro;
                      </td>
                    </tr>
                    <tr>
                      <td nowrap="" class="td1">Montant du prêt sollicité :</td>
                      <td nowrap="" class="td1">
                        <input name="PretPth" size="7" maxlength="8" onchange="ffff_OC('PretPth')" class="put1">&nbsp;&euro;
                      </td>
                    </tr>
                    <tr>
                      <td nowrap="" colspan="2" class="td1">
                        ...
                        <select name="NbLogement" size="1" onchange="ffff_OC('NbLogement')" style="float:right;">
                          <option value="1">1 &Atilde;  10 logements</option>
                          <option value="11">11 &Atilde;  24 logements</option>
                          <option value="25">25 &Atilde;  99 logements</option>
                    ...
                    <tr>
                      <td nowrap="" colspan="2" class="td1">
                        <label for="IsNegocie">
                          <input id="IsNegocie" type="checkbox" name="IsNegocie" value="1" onclick="ffff_OC('IsNegocie')">Bien négocié auprès du notaire
                        </label>
                      </td>
                    </tr>
                  </table>
        ...
        <tr>
          <td valign="center" align="center">
            <input name="BtnSubmit" type="button" value="Calculer !" onclick="OnBtnSubmit(ffff)">
          </td>
        </tr>
        <tr>
          <td valign="top">
            <table border="0" cellspacing="1" cellpadding="4" height="100" width="100%" class="tab1">
              <tr>
                <td nowrap="" valign="top" align="center" width="50%" class="td3">Montant estimé<br>des frais de notaire<br>sur lacquisition :<br>&nbsp;<br><font class="td1r">
                    <div id="result_FnTotal"></div></font></td>
                <td nowrap="" valign="top" align="center" width="50%" class="td3">Montant estimé<br>des frais dhypothèque<br>sur le prêt :<br>&nbsp;<br><font class="td1r">
                    <div id="result_FgTotal"></div></font></td>
              </tr>
            </table>
            <div id="divreal" align="right"><a href="http://www.alto-informatique.com" target="_blank" class="Note1">Réalisation alto-informatique.com</a></div>
          </td>
        </tr>
      </table>
    </form>
