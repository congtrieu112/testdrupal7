    ...
    <div class="contactUs__informations">
      <div class="small-wrapper">
        ...
        <div class="contactUs__informations__cta">
          <a href="tel://<?echo $content['kandb_contact_numero_vert']; ?>" class="btn-phone-green"><span><?echo $content['kandb_contact_numero_text']; ?></span><?echo $content['kandb_contact_numero_vert']; ?></a>
          <a href="<?echo $content['kandb_contact_faq_link']; ?>" class="btn-white"><?echo $content['kandb_contact_faq_text']; ?><span class="icon icon-arrow"></span></a>
        </div>
      </div>
    </div>
