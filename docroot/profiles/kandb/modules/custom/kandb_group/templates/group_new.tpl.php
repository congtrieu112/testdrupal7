                                    ...
                                    <?php if (isset($node->field_document_file[LANGUAGE_NONE])) : ?>
                                      <?php foreach ($node->field_document_file[LANGUAGE_NONE] as $file) : ?>
                                        ...
                                        <?php if ($document_file != '') : ?>
                                          <div class="downloadDocs__item__link"><a href="<?php print $document_file; ?>" title="<?php print $file['filename']; ?>" onclick="javascript:return tc_events_1(this,'CLICK',{'LABEL':'actualites::<?php print kandb_tagcommander_sanitize_for_event($file['filename']); ?>','XTCLICK_EVENT':'C','XTCLICK_S2':'5','XTCLICK_TYPE':'T'});"><span class="icon icon-download-pdf"></span></a></div>
                                                <?php endif; ?>
                                              <?php endforeach; ?>
                                            <?php endif; ?>
                                </div>
