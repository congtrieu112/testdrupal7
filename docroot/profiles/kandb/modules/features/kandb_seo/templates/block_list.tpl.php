            ...
            <dl>
              ...
              <dd>
                <ul>
                  ...
                  <li><a href="/<?php print $location; ?>/logements-immobiliers-neufs-<?php print $object['sanitize_name']; ?>-<?php print $object['numero_departement']; ?>" title="Logements neufs à <?php print $object['name']; ?>">Logements neufs <?php print $object['name']; ?></a></li>
                </ul>
              </dd>
            </dl>
          </div>
