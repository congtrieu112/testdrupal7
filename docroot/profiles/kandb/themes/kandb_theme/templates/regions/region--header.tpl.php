...
<div class="sticky contain-to-grid">
  <div class="fixed">
    <nav data-topbar="" role="banner" class="wrapper header">
      <button aria-label="" class="hide-for-medium-up menu-btn"><span>Ouvrir le menu</span></button>
      <div class="header__title">
        <ul class="title-area">
          <li class="name"><a href="<?php print $base_url; ?>" title="K&amp;B homepage" class="title-area__link">
              <h1><img src="<?php print $logo_svg; ?>" alt="Kaufman&amp;Board"></h1></a></li>
          <li role="search" class="title-area__search notVisible">
            <button aria-label="Ouvrir l a recherche" aria-haspopup="true" data-topbar-search="" class="icon icon-search"></button>
          </li>
        </ul>
        <aside aria-hidden="true" class="wrapper header__search js-topbarSearch">
          <form action="/<?php print URL_SEARCH_B2C; ?>" method="get" nov alidate="" class="smallSearch">
            ...
            <div class="smallSearch__input">
              <input type="search" placeholder="Ville, département ou programme" required="" pattern="(.){2,}$" class="noScroll"><span class="topbarSearchError">Saisir au moins 2 charactères</span>
            </div>
