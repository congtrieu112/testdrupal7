            ...
            <div class="toolbox">
                ...
                <div class="sharing">
                    <ul class="sharing__items">
                        ...
                        <?php if (variable_get('kb_partage_email')) : ?>
                            <li class="sharing__items__item">
                                <a href="mailto:<?php print variable_get('kb_partage_email');  ?>" title="partage par email" class="icon icon-email"></a>
                            </li>
                        <?php endif; ?>
                        <li class="sharing__items__item"><a target="_blank" href="http://www.facebook.com/sharer/sharer.php?u=<?php print $GLOBALS['base_url'].url('node/' . $node->nid) ?>" title="partage sur Facebook" class="icon icon-facebook"></a></li>
                        <li class="sharing__items__item"><a target="_blank" href="http://twitter.com/share?url=<?php print $GLOBALS['base_url'].url('node/' . $node->nid) ?>" title="partage sur Twitter" class="icon icon-twitter"></a></li>
                    </ul>
                </div>
            </div>
