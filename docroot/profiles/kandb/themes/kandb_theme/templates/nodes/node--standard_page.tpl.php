...
<!-- [editorial Content Standard page] start-->
    ...
    <div class="wrapper">
        ...
        <div class="row">
          <div class="editorialContentArticle__content">
              <?php print (isset($node->body[LANGUAGE_NONE][0]["value"])) ? $node->body[LANGUAGE_NONE][0]["value"] : ''; ?>
          </div>
        </div>
    </div>
</article>
<!-- [editorial Content Standard page] end-->
